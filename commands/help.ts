...
const Embeds = {
    index: new EmbedBuilder()
        ...
        .addFields(
            ...
            { name: "🌐 Nexus", value: `[Invite BankingBot](https://discord.com/api/oauth2/authorize?client_id=1002698891537424384&permissions=101376&scope=bot) • [Discord Server](${Config.permInvite}) • [Upvote](https://discordbotlist.com/bots/bankingbot/upvote)` }
        )
